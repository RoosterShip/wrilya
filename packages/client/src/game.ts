...
export default class Game {
  ...
  public static GetGameConfig() {
    return Game.Instance().getConfig();
  }
  ...
  public static SessionData(): object {
    return Game.Instance().mSessionData!;
  }
  
  public static SetSessionData(data: object) {
    Game.Instance().mSessionData = data;
  }
  ...
  public static IsActive(): boolean {
    return Game.Instance().getActive();
  }
  ...
  private getConfig() {
    const { GameConfig } = this.mMUDComponents!;
