...
export default class ButtonSecurity extends ButtonStd {
    ...
    constructor(scene: Phaser.Scene, x?: number, y?: number) {
        ...
        // icon_security
        const icon_security = scene.add.image(25, 26, "icon_security");
        this.add(icon_security);

        // lbl_text
        const lbl_text = scene.add.text(45, 15, "", {});
        lbl_text.text = "Account Security";
