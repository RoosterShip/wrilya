...
export default class ButtonCommunityGuidelines extends ButtonStd {
    ...
    constructor(scene: Phaser.Scene, x?: number, y?: number) {
        ...
        // icon_pg
        const icon_pg = scene.add.image(25, 26, "icon_pg");
        this.add(icon_pg);

        // lbl_text
        const lbl_text = scene.add.text(45, 15, "", {});
        lbl_text.text = "Community Guidelines";
        lbl_text.setStyle({ "color": "#4dd9f2", "fontFamily": "Eurostile Bold Extended", "fontSize": "24px", "shadow.offsetY":1,"shadow.color": "#000000ff", "shadow.blur":1,"shadow.fill":true});
        this.add(lbl_text);
