...
export default class ButtonSupport extends ButtonStd {
    ...
    constructor(scene: Phaser.Scene, x?: number, y?: number) {
        ...
        // icon_support
        const icon_support = scene.add.image(25, 26, "icon_support");
        this.add(icon_support);

        // lbl_text
        const lbl_text = scene.add.text(45, 15, "", {});
        lbl_text.text = "Contact Support";
