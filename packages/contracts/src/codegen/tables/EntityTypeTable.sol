...
// Import user types
import { EntityEnum } from "./../common.sol";

library EntityTypeTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "game", name: "EntityTypeTable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d6500000000000000000000456e74697479547970655461626c6500);
   ...
   */
  function encodeStatic(EntityEnum value) internal pure returns (bytes memory) {
   ...
   */
  function encode(EntityEnum value) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
