...
library EntityCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "EntityCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000456e74697479436f756e746572000000);
