...
library LedgerInfo {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wrilya", name: "LedgerInfo", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627772696c796100000000000000004c6564676572496e666f000000000000);
  ...
  function setStaked(bytes32 owner, uint256 staked) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((staked)), _fieldLayout);
  }
  ...
  function _setStaked(bytes32 owner, uint256 staked) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((staked)), _fieldLayout);
  }
  ...
  function setUnstaked(bytes32 owner, uint256 unstaked) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((unstaked)), _fieldLayout);
  }
  ...
  function _setUnstaked(bytes32 owner, uint256 unstaked) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((unstaked)), _fieldLayout);
  }
  ...
  function setUts(bytes32 owner, uint256 uts) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((uts)), _fieldLayout);
  }
  ...
  function _setUts(bytes32 owner, uint256 uts) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((uts)), _fieldLayout);
  }
  ...
  function get(
    ...
    internal
    view
    returns (uint256 tokens, uint256 credits, uint256 debit, uint256 staked, uint256 unstaked, uint256 uts)
  {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = owner;
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(tokens, credits, debit, staked, unstaked, uts);
    ...
    returns (uint256 tokens, uint256 credits, uint256 debit, uint256 staked, uint256 unstaked, uint256 uts)
  {
    ...
    debit = (uint256(Bytes.getBytes32(_blob, 64)));

    staked = (uint256(Bytes.getBytes32(_blob, 96)));

    unstaked = (uint256(Bytes.getBytes32(_blob, 128)));

    uts = (uint256(Bytes.getBytes32(_blob, 160)));
  }
  ...
  function decode(
    ...
    returns (uint256 tokens, uint256 credits, uint256 debit, uint256 staked, uint256 unstaked, uint256 uts)
  {
    (tokens, credits, debit, staked, unstaked, uts) = decodeStatic(_staticData);
  }
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(tokens, credits, debit, staked, unstaked, uts);
  }
