...
library GameConfig {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wrilya", name: "GameConfig", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627772696c7961000000000000000047616d65436f6e666967000000000000);
  ...
  function getFieldNames() internal pure returns (string[] memory fieldNames) {
    ...
    fieldNames[0] = "active";
    fieldNames[1] = "governor";
    fieldNames[2] = "gm";
    fieldNames[3] = "payee";
    fieldNames[4] = "currencyProxy";
    fieldNames[5] = "itemProxy";
    fieldNames[6] = "entityProxy";
  }
  ...
  function setGovernor(address governor) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((governor)), _fieldLayout);
  }
  ...
  function _setGovernor(address governor) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((governor)), _fieldLayout);
  }
   ...
   * @notice Get payee.
   */
  function getPayee() internal view returns (address payee) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get payee.
   */
  function _getPayee() internal view returns (address payee) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set payee.
   */
  function setPayee(address payee) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((payee)), _fieldLayout);
  }
  ...
  function _setPayee(address payee) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((payee)), _fieldLayout);
  }
  ...
  function setCurrencyProxy(address currencyProxy) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((currencyProxy)), _fieldLayout);
  }
  ...
  function _setCurrencyProxy(address currencyProxy) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((currencyProxy)), _fieldLayout);
  }
  ...
  function setItemProxy(address itemProxy) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((itemProxy)), _fieldLayout);
  }
  ...
  function _setItemProxy(address itemProxy) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((itemProxy)), _fieldLayout);
  }
  ...
  function setEntityProxy(address entityProxy) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 6, abi.encodePacked((entityProxy)), _fieldLayout);
  }
  ...
  function _setEntityProxy(address entityProxy) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 6, abi.encodePacked((entityProxy)), _fieldLayout);
  }
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(active, governor, gm, payee, currencyProxy, itemProxy, entityProxy);
    ...
    )
  {
    ...
    governor = (address(Bytes.getBytes20(_blob, 1)));

    gm = (address(Bytes.getBytes20(_blob, 21)));

    payee = (address(Bytes.getBytes20(_blob, 41)));

    currencyProxy = (address(Bytes.getBytes20(_blob, 61)));

    itemProxy = (address(Bytes.getBytes20(_blob, 81)));

    entityProxy = (address(Bytes.getBytes20(_blob, 101)));
  }
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(active, governor, gm, payee, currencyProxy, itemProxy, entityProxy);
  }
