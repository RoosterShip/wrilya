...
library EntityOwnerTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "game", name: "EntityOwnerTable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d6500000000000000000000456e746974794f776e65725461626c65);
