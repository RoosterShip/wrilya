...
library PortraitTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "PortraitTable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000506f7274726169745461626c65000000);
