...
library EntityXPTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "game", name: "EntityXPTable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d6500000000000000000000456e7469747958505461626c65000000);
   ...
   * @notice Get value.
   */
  function _getValue(bytes32 entity) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
   ...
   * @notice Get value.
   */
  function _get(bytes32 entity) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
   ...
   * @notice Set value.
   */
  function _setValue(bytes32 entity, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
   ...
   * @notice Set value.
   */
  function _set(bytes32 entity, uint32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
