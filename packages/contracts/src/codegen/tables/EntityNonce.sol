...
library EntityNonce {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wrilya", name: "EntityNonce", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627772696c79610000000000000000456e746974794e6f6e63650000000000);
