...
library Crew {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Crew", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000043726577000000000000000000000000);
