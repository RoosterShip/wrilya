...
library Ship {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Ship", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000053686970000000000000000000000000);
