...
library CommandNonce {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wrilya", name: "CommandNonce", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627772696c79610000000000000000436f6d6d616e644e6f6e636500000000);
