...
library BanPerm {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wrilya", name: "BanPerm", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627772696c7961000000000000000042616e5065726d000000000000000000);
