...
library MPNonce {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "wrilya", name: "MPNonce", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627772696c796100000000000000004d504e6f6e6365000000000000000000);
